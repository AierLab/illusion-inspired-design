...
from model.model_102_v2 import *

def main(model_name):
    # Initialize Wandb logger with a careful naming convention for the model
    wandb_logger = WandbLogger(project="illusion_augmented_models", save_dir="tmp", name=f"model_m_X_102_v2_{model_name}", log_model=True)
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor="val_acc",
        dirpath=f"./tmp/models/m_X_102_v2_{model_name}/",
    ...
    checkpoint_dir = f"./tmp/models/m_X_102_v2_{model_name}/"
