import torch
from .imagenet1k import main as imagenet1k_main
from .indl224 import main as indl224_main
from ._base import *
...
def main():
    train_dataset, val_dataset = imagenet1k_main(raw=True)
    combined_trainset, combined_testset = indl224_main(raw=True)
