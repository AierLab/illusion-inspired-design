...
from .indl224_filtered import dataset_filter as df
from ._base import *
...
def dataset_combine(combined_trainset, combined_testset):
    ...
    trainloader_combined = DataLoader(combined_trainset_final, batch_size=256//8, shuffle=True, num_workers=num_workers, pin_memory=True)

    # Create DataLoader for combined testing dataset (with labels changed to 11 and 12)
    testloader_combined = DataLoader(combined_testset_final, batch_size=256//8, shuffle=False, num_workers=num_workers, pin_memory=True)
