...
train_pth_file = "assets/datasets/indl/train/combined_trainset.pth"
test_pth_file = "assets/datasets/indl/test/combined_testset.pth"
...
if os.path.exists(train_pth_file) and os.path.exists(test_pth_file):
    ...
    for dataset_folder in ["dataset01", "dataset02", "dataset03", "dataset04", "dataset05"]:
        ...
        train_data_dir = f"assets/datasets/indl/train/{dataset_folder}"
        test_data_dir = f"assets/datasets/indl/test/{dataset_folder}"
