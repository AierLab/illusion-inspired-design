...
trainloader_combined = DataLoader(combined_trainset_final, batch_size=100, shuffle=True, num_workers=num_workers, pin_memory=True)

# Create DataLoader for combined testing dataset (with labels changed to 11 and 12)
testloader_combined = DataLoader(combined_testset_final, batch_size=100, shuffle=False, num_workers=num_workers, pin_memory=True)
