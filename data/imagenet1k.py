...
trainloader_imagenet1k = DataLoader(trainset_transformed, batch_size=64, shuffle=True, num_workers=num_workers, pin_memory=True)
testloader_imagenet1k = DataLoader(valset_transformed, batch_size=64, shuffle=False, num_workers=num_workers, pin_memory=True)
